...
from cotracker.predictor import generate_gassian_heatmap
...
class StableVideoDiffusionPipelineControlNet(DiffusionPipeline):
    ...
    def __call__(
        ...
        if with_control:
            ...
            video_gaussion_map = generate_gassian_heatmap(point_tracks, image_size=(width, height), side=side)
            ...
            controlnet_image = torch.cat([controlnet_image] * 2, dim=0) if do_classifier_free_guidance else controlnet_image
